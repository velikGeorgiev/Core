...
class Xtemplate_Compiler extends Xtemplate {
	...
	protected function _compile_file($file_contents)
	{
		...
		/** 
		**  VELKO: $file_contents = preg_replace("!{$ldq}\*.*?\*{$rdq}!se","",$file_contents);
		**/
	...
	function _parse_function($function, $modifiers, $arguments)
	{
		switch ($function) {
			case 'include':
				...
				{
					require_once(XTEMPLATE_DIR . "internal/compile.include.php");
				}
			...
			case 'section':
				...
				{
					require_once(XTEMPLATE_DIR . "internal/compile.section_start.php");
				}
	...
	function _compile_custom_function($function, $modifiers, $arguments, &$_result)
	{
		...
		{
			require_once(XTEMPLATE_DIR . "internal/compile.compile_custom_function.php");
		}
	...
	function _compile_custom_block($function, $modifiers, $arguments, &$_result)
	{
		...
		{
			require_once(XTEMPLATE_DIR . "internal/compile.compile_custom_block.php");
		}
	...
	function _compile_if($arguments, $elseif = false, $while = false)
	{
		...
		{
			require_once(XTEMPLATE_DIR . "internal/compile.compile_if.php");
		}
	...
	function _parse_is_expr($is_arg, $_arg)
	{
		...
		{
			require_once(XTEMPLATE_DIR . "internal/compile.parse_is_expr.php");
		}
	...
	function _compile_config($variable)
	{
		...
		{
			require_once(XTEMPLATE_DIR . "internal/compile.compile_config.php");
		}
