<?php
/**
 * XTemplate template_generate_debug_output template internal module
 *
 * Type:	 template
...
function template_generate_debug_output(&$object)
{
    ...
    $included_templates = $object->_xtemplate_debug_info;
    ...
    $object->assign("_xtemplate_debug_output", "");

	$object->_xtemplate_debug_loop = true;
	$object->_xtemplate_debug_dir = $object->template_dir;
	$object->template_dir = TEMPLATE_LITE_DIR . "internal/";
	$debug_output = $object->fetch("debug.tpl");
	$object->template_dir = $object->_xtemplate_debug_dir;
	$object->_xtemplate_debug_loop = false;
	return $debug_output;
}
